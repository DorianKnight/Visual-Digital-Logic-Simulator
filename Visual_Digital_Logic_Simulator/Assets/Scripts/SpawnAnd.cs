...
public class SpawnAnd : MonoBehaviour
{
    ...
    public void AddGate()
    {
        ...
        GameObject currentGate = Instantiate(objectToSpawn, convertedMousePosition, Quaternion.identity);
        chipConnectedToMouse = currentGate.transform;
        pickedUp = true;

        // Generates the inputs and outputs
        currentGate.GetComponent<AndBehaviour>().CreateIO(currentGate.transform);
    }
